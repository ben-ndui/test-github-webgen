      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-light mb-4">Test GitHub WebGen</h2>
            <p className="text-gray-400 mb-8">Tech</p>
            <div className="pt-8 border-t border-gray-800">
              <p className="text-gray-500">&copy; 2025 Test GitHub WebGen. Tous droits réservés.</p>
            </div>
          </div>
        </div>
      </footer>
